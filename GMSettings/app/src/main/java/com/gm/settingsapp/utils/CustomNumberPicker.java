...
public class CustomNumberPicker extends LinearLayout {
    ...
    /**
     *  The default string vales of text
     */

    private static final String [] Default_Text_Values = null;

    private static final int scrollViewTag =10;
     ...
     * The size of the selected text.
     */
    private float mDefaultTextSize = 70;

    /**
     * The size of the selected text.
     */
    private float mDefaultSelectedTextSize = 70;
    ...
    private int mscrollViewTag = scrollViewTag;
    ...
    public CustomNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.CustomNumberPicker, defStyle, 0);
        ...
        mWidth = attributesArray.getDimensionPixelSize(R.styleable.CustomNumberPicker_np_width, SIZE_UNSPECIFIED);
        mHeight = attributesArray.getDimensionPixelSize(R.styleable.CustomNumberPicker_np_height, SIZE_UNSPECIFIED);
        ...
        mSelectedTextColor = attributesArray.getColor(R.styleable.CustomNumberPicker_np_selectedTextColor, mSelectedTextColor);
//        mSelectedTextSize = attributesArray.getDimension(R.styleable.NumberPicker_np_selectedTextSize, spToPx(mSelectedTextSize));
//        mDefaultTextSize = attributesArray.getDimension(R.styleable.NumberPicker_np_selectedTextSize, mDefaultTextSize);
//        mDefaultSelectedTextSize = attributesArray.getDimension(R.styleable.NumberPicker_np_defaultSelectedTextSize, mDefaultSelectedTextSize);
        ...
        mscrollViewTag = attributesArray.getInt(R.styleable.CustomNumberPicker_np_scrollViewTag, mscrollViewTag);
        ...
        Typeface face= Typeface.createFromAsset(getContext().getAssets(), "fonts/gmsansui_medium.ttf");

        mSelectedText.setTypeface(face);
...
//        setSelectedTextSize(mSelectedTextSize);
        setDefaultSelectedTextSize(mDefaultSelectedTextSize);
...
//        setTypeface(mTypeface);
     ...
     * <p>
     * If the argument is less than the {@link CustomNumberPicker#getMinValue()} and
     * {@link CustomNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link CustomNumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link CustomNumberPicker#getMinValue()} and
     * {@link CustomNumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link CustomNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link CustomNumberPicker#getMaxValue()} and
     * {@link CustomNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link CustomNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link CustomNumberPicker#getMinValue()} and
     * {@link CustomNumberPicker#getMaxValue()} values.
     * <p>
     ...
     */
    public void setRideMinValue(int minValue) {
//        if (minValue < 0) {
...
//        }
     ...
     * {@link #getMaxValue()} - {@link #getMinValue()} + 1.
     */
    public void setRideMaxValue(int maxValue) {
        if (maxValue < 0) {
     ...
     * {@link #getMaxValue()} - {@link #getMinValue()} + 1.
     */
    public void setRideDisplayedValues(String[] displayedValues) {
        ...
        if (mDisplayedValues != null) {
            ...
            mMaxValue = mDisplayedValues.length - 1;
            mValue = 0;
            boolean wrapSelectorWheel = mMaxValue - mMinValue > mSelectorIndices.length;
            setWrapSelectorWheel(wrapSelectorWheel);
        } else {
    ...
    public void setNp_value(int value){
        mValue = value;
    }
...
//        }
    ...
    /*public void setSelectedTextSize(float textSize) {
        ...
        mSelectedText.setTextSize(mSelectedTextSize);
        mSelectorWheelPaint.setTextSize(mSelectedTextSize);
    }*/

    private void setSelectedTextSize(float size) {
        mSelectedTextSize = size * 1.5f;
        mSelectedText.setTextSize(pxToSp(mSelectedTextSize));
    }

    public void setDefaultSelectedTextSize(float textSize) {
        mDefaultSelectedTextSize = textSize;
        mSelectedText.setTextSize(mDefaultSelectedTextSize);
        mSelectorWheelPaint.setTextSize(mDefaultSelectedTextSize);
    }
