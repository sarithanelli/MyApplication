...
/**
 * Customising the TabLayout for Skew display format
 */
class SkewTabLayout : TabLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        val a = context.theme.obtainStyledAttributes(attrs, R.styleable.SkewTabLayout, 0, 0)
