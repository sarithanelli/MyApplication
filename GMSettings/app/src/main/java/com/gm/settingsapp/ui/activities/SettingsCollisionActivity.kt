...
class SettingsCollisionActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataPoolDataHandler.SETTINGS_COLLISION_LIST.add(CollisionModeModel(GMSettingsApp.appContext.resources.getString(R.string.settings_traffic_and_roadside_information), true, true, TRAFFIC_AND_ROADSIDE_INFORMATION, GMSettingsApp.appContext.resources.getString(R.string.settings_traffic_and_roadside_information_content), false))
        ...
        dataPoolDataHandler.SETTINGS_COLLISION_LIST.add(CollisionModeModel(GMSettingsApp.appContext.resources.getString(R.string.settings_park_assist_towbar), true, true, PARK_ASSIST_TOWBAR, GMSettingsApp.appContext.resources.getString(R.string.settings_park_assist_towbar_desc), false))
