...
class SettingsComfortAndConvenienceActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataPoolDataHandler.SETTINGS_COMFORT_AND_CONVENIENCE.add(ComfortAndConvenienceModel(GMSettingsApp.appContext.resources.getString(R.string.settings_automatic_vehicle_hold_long), C_EXTENDED_HILL_START_ASSIST))
    ...
    override fun onEventResponse(view: View, obj: Any?) {
        when ((obj as ComfortAndConvenienceModel).ref) {
            ...
            C_EXTENDED_HILL_START_ASSIST -> view.tag = Constants.EXTENDED_HILL_START_ASSIST
        }
    }
}