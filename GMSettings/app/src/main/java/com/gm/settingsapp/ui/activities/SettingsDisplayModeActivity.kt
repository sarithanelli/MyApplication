 ...
 */
class
SettingsDisplayModeActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = setContentSubView(R.layout.ics_settings_system_display_mode) as Settingsdisplaymodebinding
        binding.let {
    ...
    override fun onResume() {
        super.onResume()
        headerTitle(getString(R.string.settings_mode))
    }
