...
class GMSettingsManager @Inject constructor(val systemListener: SystemListener, val customization: Customization) : GMSettingsListenerManager.IVehicleDataChangedListener {


  /*  override fun onEventReceived(regEventName: Enum<out EventsGroup>, data: Any) {
      ...
      //  EventBus.sub.attachConsumer(this,ConnectivityEvent::class.java, VehicleEvent::class.java,SystemEvents::class.java)
       /* val setupAppRoutingUseCase = SetupDomainUseCase(SettingsService.appContext)
         setupAppRoutingUseCase.execute(object : Observer.Acceptor<Void> {
            ...
            //    EventBus.sub.detachConsumer(SettingsService.appContext);
            }
