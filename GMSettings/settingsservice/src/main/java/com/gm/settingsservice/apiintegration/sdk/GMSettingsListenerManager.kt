...
import com.gm.settings.core.EventConsumer
import com.gm.settings.core.EventsGroup
...
class GMSettingsListenerManager(eventConsumer: Any,data: Any, _INSTANCE: Any, private val regEventName: String) : OnVehicleDataChangedListener {
    ...
    private val eventConsumer : EventConsumer = eventConsumer as EventConsumer
   ...
   /* interface IEventConsumer{
        fun onEventReceived(regEventName: Enum<out EventsGroup>, data: Any)
    }


    override fun onEventReceived(p0: Enum<out EventsGroup>?, p1: Any?) {
